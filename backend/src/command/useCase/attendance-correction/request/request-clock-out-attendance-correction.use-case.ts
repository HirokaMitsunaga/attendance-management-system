...
export type RequestClockOutAttendanceCorrectionParams = {
  userId: string;
  workDate: Date;
  reason: string;
  occurredAt: Date;
...
@Injectable()
export class RequestClockOutAttendanceCorrectionUseCase {
  constructor(
  ...
  async execute(
    params: RequestClockOutAttendanceCorrectionParams,
  ): Promise<void> {
