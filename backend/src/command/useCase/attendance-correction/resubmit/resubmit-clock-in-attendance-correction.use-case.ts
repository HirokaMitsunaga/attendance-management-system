...
export type ResubmitClockInAttendanceCorrectionParams = {
  userId: string;
  workDate: Date;
  requestedBy: string;
  reason: string | null;
...
@Injectable()
export class ResubmitClockInAttendanceCorrectionUseCase {
  constructor(
  ...
  async execute(
    params: ResubmitClockInAttendanceCorrectionParams,
  ): Promise<void> {
